...
from keras.layers import Dense, Activation, Dropout,Conv2D,Flatten,BatchNormalization,Activation,MaxPooling2D
...
model.add(Dense(128, input_shape=(len(train_x[0]),), activation='relu'))#input
#model.add(Conv2D(64, (5, 5), kernel_initializer="he_normal"))
